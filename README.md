...
#### 使用/Issues
 ...
 2. 未解决：    
    ...
    独显驱动：现已可以正常升级到montereyb4（b5应该也可以但还未来得及测试），升级前请将polaris22fixup.kext替换成这个链接中的个kext https://github.com/osy/Polaris22Fixup/pull/16 ~~由于新系统的变动，独显尚未适配macOS Monterey，请暂缓升级到macOS12.0及以上版本~~
